// A38WhitherDesignChallenge20.js for Perlenspiel 3.3
...
const W = ( function () {
	...
	const _make_floor = function ( x, y ) {
		PS.color( x, y, _COLOR_FLOOR );
	...
	function endgame() {
		_play = false; //disable play
		_make_floor(PS.ALL, PS.ALL); //Fixes weird fader thing
	...
	return {
		init : function () {
			...
			PS.audioLoad( "A38WhitherDesignChallengeFull", {
				onLoad : _loaded,
				loop : true,
				lock : true
			} );
