...
// Mod 5: Added functionality that updates the status text when the entire grid is changed to black,
		  and reverts it if beads are changed back to white.
// Mod 6: Added a celebratory sound effect when the grid is entirely black
